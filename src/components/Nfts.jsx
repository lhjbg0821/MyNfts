...
const Nfts = ({ page, totalNft, mintedNft }) => {
  ...
  return (
    <div className="bg-gradient-to-b from-main to-gray-950">
      <div className=" max-w-screen-xl mx-auto pt-8 text-gray-700">
        <div className="flex font-bold text-2xl mb-8 ">
          <button className="mr-8 hover:text-gray-50">아이템</button>
          <Link to={"/log"}>
            <button className="hover:text-gray-50  ">활동내역</button>
          </Link>
        </div>
